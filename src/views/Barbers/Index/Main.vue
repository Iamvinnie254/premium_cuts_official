      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="mt-6 text-lg text-gray-300">
            Skilled professionals dedicated to giving you the perfect grooming experience.
          </p>
        </div>
      </div>
    </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            >
              ...
              <div class="p-6">
                ...
                <p class="text-amber-600 font-medium mb-3">{{ barber.title }}</p>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div class="p-6">
                ...
                <p class="text-amber-600 font-medium mb-3">{{ member.title }}</p>
          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                ...
                <p class="text-amber-600 font-medium mb-6">{{ selectedMember.title }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div class="md:col-span-2">
                    ...
                    <div v-if="isBarber(selectedMember)" class="mb-6">
                      <h4 class="font-medium text-gray-900 mb-2">Specialties</h4>
                    ...
                    <div class="mb-6">
                      ...
                      <p class="text-gray-600">{{ selectedMember.experience }} years in the industry</p>
                    </div>
                    
                    <!-- Barbers Only: Stats -->
                    <div v-if="isBarber(selectedMember)" class="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        <p class="text-3xl font-bold text-amber-600">{{ selectedMember.rating }}</p>
                        <p class="text-gray-500 text-sm">Customer Rating</p>
                      </div>
                      <div>
                        <p class="text-3xl font-bold text-amber-600">{{ selectedMember.clients }}+</p>
                    ...
                    <div>
                      ...
                      <div class="space-y-2">
                        <div v-if="selectedMember.email" class="flex items-center">
                          <svg class="w-5 h-5 text-gray-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                          </svg>
                          <a :href="'mailto:' + selectedMember.email" class="text-gray-600 hover:text-amber-600">{{ selectedMember.email }}</a>
                        </div>
                        <div v-if="selectedMember.phone" class="flex items-center">
                          <svg class="w-5 h-5 text-gray-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                          </svg>
                          <a :href="'tel:' + selectedMember.phone" class="text-gray-600 hover:text-amber-600">{{ selectedMember.phone }}</a>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      barbers: [
        {
          ...
          specialties: ["Skin Fades", "Classic Cuts", "Beard Sculpting", "Hot Towel Shaves"],
        ...
        },
        {
          ...
          specialties: ["Trendy Styles", "Hair Designs", "Color Treatments", "Kids Cuts"],
        ...
        },
        {
          ...
          specialties: ["Beard Grooming", "Mustache Styling", "Straight Razor Shaves", "Beard Coloring"],
        ...
        },
        {
          ...
          specialties: ["Traditional Cuts", "Scissor Work", "Kids Cuts", "Hair Treatments"],
