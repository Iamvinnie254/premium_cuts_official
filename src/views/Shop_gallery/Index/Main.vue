  ...
  <div class="bg-white">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="mt-6 text-lg text-gray-300">
            Step inside our world of precision cuts and premium grooming experiences.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-if="activeFilter === 'transformations'" class="mb-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <div class="absolute inset-y-0 left-1/2 w-1 bg-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-ew-resize">
                <div class="absolute -left-3 -top-3 bg-white rounded-full p-2 shadow-md">
          ...
          >
            ...
            <div class="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
              <div class="translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <p v-if="image.barber" class="text-amber-300 text-sm">By {{ image.barber }}</p>
              </div>
            </div>
            <div 
        ...
        <div class="mt-16 text-center bg-gray-50 rounded-xl p-8">
          <div class="max-w-2xl mx-auto">
            <svg class="w-10 h-10 mx-auto text-pink-600 mb-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="text-2xl font-bold text-gray-900 mb-2">Follow Our Daily Work</h3>
            <p class="text-gray-600 mb-6">See more transformations, behind-the-scenes, and styling tips on our Instagram.</p>
            <a 
    ...
    <div v-if="lightbox.active" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom rounded-lg text-left overflow-hidden transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          <div class="relative">
            <button 
              @click="closeLightbox"
            ...
            <button 
              v-if="lightbox.type === 'gallery' && lightbox.index < filteredGallery.length - 1"
              @click.stop="navigateLightbox(1)"
            ...
            <div v-if="lightbox.type === 'beforeAfter'" class="relative h-screen max-h-[80vh]">
              <div class="absolute inset-0 flex items-center justify-center">
                <img 
                  :src="beforeAfterItems[lightbox.index].before" 
                  :alt="'Before: ' + beforeAfterItems[lightbox.index].description"
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <img 
                  ...
                  :alt="'After: ' + beforeAfterItems[lightbox.index].description"
                  class="max-w-full max-h-full object-contain"
                  :style="{ clipPath: 'inset(0 ' + (100 - lightbox.sliderPosition) + '% 0 0)' }"
                >
              </div>
              <div 
              ...
              <div class="absolute bottom-4 left-0 right-0 text-center">
                <div class="inline-flex bg-black/70 text-white px-4 py-2 rounded-full">
            ...
            <div v-else class="relative h-screen max-h-[80vh]">
              <div class="absolute inset-0 flex items-center justify-center">
                ...
                >
                  <source :src="filteredGallery[lightbox.index].src" type="video/mp4">
                  Your browser does not support the video tag.
                </video>
              </div>
              <div class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                <p class="text-white font-medium text-center">{{ filteredGallery[lightbox.index].caption }}</p>
                <p v-if="filteredGallery[lightbox.index].barber" class="text-amber-300 text-sm text-center">
